<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="生活照" align="center" width="100">
        <template slot-scope="scope">
          <img :src="scope.row.idcard3" alt width="70">
        </template>
      </el-table-column>
      ...
      <el-table-column align="center" label="状态">
        <template slot-scope="scope">
          ...
          <!-- <span>待审核</span> -->
          <span>{{ scope.row.display_time }}待审核</span>
        </template>
      </el-table-column>
      <el-table-column align="center" label="操作">
        <template slot-scope="scope">
          <div>
            ...
            <el-button size="mini" type="success" @click="passmodal(scope.row)">通过</el-button>
            <el-button size="mini" type="danger" @click="rejectionmodal(scope.row)">驳回</el-button>
          </div>
        </template>
      </el-table-column>
    </el-table>
...
export default {
  ...
  methods: {
    fetchData() {
      ...
      axios
        .get("http://212.64.64.99:8888/admin/teacherapplylist")
        .then(function(res) {
          console.log(res);
